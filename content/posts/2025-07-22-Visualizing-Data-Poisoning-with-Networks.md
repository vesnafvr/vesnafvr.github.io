...
Initial Graph (before modifying)
![Alt text](/images/screenshot2.png)
 Adding edges that create interactions between characters that did not exist at all in the first place.
![Alt text](/images/screenshot3.png)
By removing/deleting edges, we can delete important interactions in the data
...
Initially, I did a tiny modification that would be nearly impossible to see. The added nodes are highlighted with green. 
![Alt text](/images/screenshot6.png)
Closer look with labels, the added nodes and edges are in green.
